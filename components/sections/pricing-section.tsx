  ...
  const plans = [
    {
      ...
      description: "Perfect for small homes or minor infestations.",
      price: "From $149",
      duration: "",
      features: [
    ...
    {
      name: "Standard Plan",
      description: "Ideal for medium infestations or repeat prevention.",
      price: "From $249",
      duration: "",
      features: [
        "Full inspection and treatment",
        "Sealing of minor entry points",
        "Sanitation and proofing advice",
        "2 follow-up visits within 30 days",
      ],
      cta: "Book Standard Plan",
      popular: true,
    },
    {
      name: "Comprehensive Protection",
      description: "For commercial properties or ongoing prevention.",
      price: "From $499",
      duration: "",
      features: [
        "Regular inspections and treatments",
        "Rodent-proofing with mesh barriers",
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400 opacity-70">
                Choose the service plan that fits your needs. No hidden fees, just clear and effective pest control.
              </p>
            </div>
          </div>
        </ScrollReveal>
